...
# Source0-md5:	b9307b3de0d15880a57c23a007bffca4
Source1:	http://dl.sourceforge.net/k3b/k3b-i18n-%{version}.tar.bz2
# Source1-md5:	3c9b3e76e7781f15b1373f2f5c1dc0b3
...
Moduł dekodujący pliki w formacie WMA (i nie tylko).
...
Moduł kodujący pliki w wielu formatach przy użyciu programu sox.
...
Pakiet zawiera wtyczki (a dokładniej "servicemenus") rozszerzające
funkcjonalność Konquerora.
...
Wtyczka odtwarzania dźwięku przez ALSA.
...
Wtyczka odtwarzania dźwięku przez arts.
